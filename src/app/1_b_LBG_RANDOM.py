...
perturbaciones_aleatorias = np.array(
                [
                    1 + e,
                    1 - e
                ],
...
print("Perturbaciones aleatorias generadas para LBG:")
print(perturbaciones_aleatorias)
...
def graficar_en_eje(ax, puntos, etiquetas, centroides, titulo, seed=42):
    ...
    # Centroides con el mismo color de su región
    ax.scatter(
        centroides[:, 0],
        centroides[:, 1],
        c=np.arange(k),
